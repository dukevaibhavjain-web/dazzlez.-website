...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "blogs_publishing_history" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "blog_timing_settings_slot_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "blog_timing_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN "keyword_bank_id" integer;
  ...
  CREATE INDEX "events_event_name_idx" ON "events" USING btree ("event_name");
  CREATE INDEX "events_page_url_idx" ON "events" USING btree ("page_url");
  CREATE INDEX "events_utm_source_idx" ON "events" USING btree ("utm_source");
  CREATE INDEX "events_utm_medium_idx" ON "events" USING btree ("utm_medium");
  CREATE INDEX "events_utm_campaign_idx" ON "events" USING btree ("utm_campaign");
  CREATE INDEX "events_order_id_idx" ON "events" USING btree ("order_id");
  CREATE INDEX "events_blog_slug_idx" ON "events" USING btree ("blog_slug");
  CREATE INDEX "events_timestamp_idx" ON "events" USING btree ("timestamp");
  CREATE INDEX "events_updated_at_idx" ON "events" USING btree ("updated_at");
  CREATE INDEX "events_created_at_idx" ON "events" USING btree ("created_at");
  CREATE INDEX "blog_categories_name_idx" ON "blog_categories" USING btree ("name");
  ...
  CREATE UNIQUE INDEX "keyword_bank_keyword_idx" ON "keyword_bank" USING btree ("keyword");
  CREATE INDEX "keyword_bank_search_intent_idx" ON "keyword_bank" USING btree ("search_intent");
  CREATE INDEX "keyword_bank_related_category_idx" ON "keyword_bank" USING btree ("related_category_id");
  CREATE INDEX "keyword_bank_related_occasion_idx" ON "keyword_bank" USING btree ("related_occasion_id");
  CREATE INDEX "keyword_bank_blog_used_idx" ON "keyword_bank" USING btree ("blog_used_id");
  CREATE INDEX "keyword_bank_approved_idx" ON "keyword_bank" USING btree ("approved");
  CREATE INDEX "keyword_bank_updated_at_idx" ON "keyword_bank" USING btree ("updated_at");
  CREATE INDEX "keyword_bank_created_at_idx" ON "keyword_bank" USING btree ("created_at");
  CREATE INDEX "blogs_keywords_order_idx" ON "blogs_keywords" USING btree ("_order");
  CREATE INDEX "blogs_keywords_parent_id_idx" ON "blogs_keywords" USING btree ("_parent_id");
  CREATE INDEX "blogs_publishing_history_order_idx" ON "blogs_publishing_history" USING btree ("_order");
  CREATE INDEX "blogs_publishing_history_parent_id_idx" ON "blogs_publishing_history" USING btree ("_parent_id");
  ...
  CREATE INDEX "blogs_ab_test_slot_idx" ON "blogs" USING btree ("ab_test_slot");
  ...
  CREATE INDEX "blogs_rels_products_id_idx" ON "blogs_rels" USING btree ("products_id");
  CREATE INDEX "blogs_rels_categories_id_idx" ON "blogs_rels" USING btree ("categories_id");
  CREATE INDEX "blog_timing_settings_slot_stats_order_idx" ON "blog_timing_settings_slot_stats" USING btree ("_order");
  CREATE INDEX "blog_timing_settings_slot_stats_parent_id_idx" ON "blog_timing_settings_slot_stats" USING btree ("_parent_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_keyword_bank_id_idx" ON "payload_locked_documents_rels" USING btree ("keyword_bank_id");
